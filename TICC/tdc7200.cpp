...
int64_t tdc7200Channel::read() {
  ...
  tof = (int64_t)(clock1Result * PS_PER_SEC )/ (int64_t)CLOCK_HZ;
  ...
  normLSB = ( (int64_t)PS_PER_SEC * (int64_t)1000000000000 ) / ((int64_t)calCount * (int64_t)CLOCK_HZ);
